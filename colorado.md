...
As Colorado is due to receive an additional U.S. House seat as part of the 2020 redistricting cycle – bringing their congressional districts from 7 to 8 – map drawers can also use GerryChain to decide where to selectively place districts of interest. Our [Texas case study](https://uwescience.github.io/DSSG2021-redistricting-website/texas/) outlines how to evaluate the placement of new districts, specifically in compliance with the Voting Rights Act of 1965.
